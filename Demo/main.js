...
import {
  downloadFlo as downloadFloInternal,
  downloadWav as downloadWavInternal,
} from "./js/download.js";
import {
  streamFromFile,
  playStreamedAudio,
  stopStreaming,
  debugCompareDecodeMethods,
...
window.setEncodingMode = function (mode) {
  ...
  document
    .getElementById("modeLossless")
    .classList.toggle("active", mode === "lossless");
  document
    .getElementById("modeLossy")
    .classList.toggle("active", mode === "lossy");
